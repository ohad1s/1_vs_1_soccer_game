...
class Game:
    ...
    def draw_window(self, hal, vini, hal_goals, vini_goals, ball, goal_right, goal_left, target_r, target_l):
        '''
            A method responsible for organizing the screen display
        '''
    ...
    def restart_ball(self, ball):
        '''
            A method to restart ball position after a goal
        '''
    ...
    def celebrate_goal(self):
        '''
            A method responsible for celebrating a goal
        '''
    ...
    def ball_moving(self, ball, vini, hal, goal_left, goal_right, target_r, target_l):
        '''
            A method responsible for moving the ball
            in cases:
            - ball touching the screen frame / ball hit the post
    ...
    def vini_handle_movment(self, key_pressed, vini):
        '''
            A method responsible for moving player one
        '''
    ...
    def hal_handle_movment(self, key_pressed, hal):
        '''
            A method responsible for moving player two
        '''
    ...
    def draw_winner(self, text):
        '''
            A method responsible for the announcement of the winner
        '''
        WINNER_FONT = pygame.font.SysFont('comicsans', 100)
        draw_text = WINNER_FONT.render(text, 1, WHITE)
        if text == "Tie":
            self.screen.blit(draw_text,
    ...
    def play(self):
        '''
            main loop in order to play the game
        '''
        ...
        while run:
            ...
            self.draw_window(hal, vini, self.hal_goals, self.vini_goals, ball, goal_right, goal_left, target_r,
                             target_l)
